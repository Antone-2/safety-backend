...
export declare const CreateUserSchema: z.ZodObject<{
    ...
    name: z.ZodString;
    role: z.ZodOptional<z.ZodEnum<["super-admin", "EHS-manager", "EHS-officer", "she-committee-member", "supervisor", "gm", "plant-manager", "factory-manager", "depot-admin", "maintenance-manager", "issuer"]>>;
    phone: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
    name: string;
    email: string;
    password?: string | undefined;
    role?: "super-admin" | "EHS-manager" | "EHS-officer" | "plant-manager" | "factory-manager" | "supervisor" | "depot-admin" | "she-committee-member" | "gm" | "maintenance-manager" | "issuer" | undefined;

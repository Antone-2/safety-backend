...
export declare function tryParseReportDate(value: unknown, referenceDate?: Date): string | undefined;
export declare function parseReportDate(value: unknown, referenceDate?: Date): string;

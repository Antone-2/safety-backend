...
import { findReportsNeedingFollowup } from "../services/report-followup.service.js";
...
async function startWorkers() {
  try {
    ...
    const followupQueue = createQueue<{ reportId?: string; stage?: string }>("followup");
    await followupQueue.add(
      "process-followup-batch",
      { reportId: "", stage: "" },
      {

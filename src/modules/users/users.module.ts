...
const service = new UsersService(
  ...
  new OrganizationService(new OrganizationRepository(pgPool)),
);
...
export function createUsersRouter() {
  ...
  router.get("/", rbacMiddleware("users:read"), async (req: AuthRequest, res) => {
  ...
  router.post("/", rbacMiddleware("users:create"), async (req: AuthRequest, res) => {
  ...
  router.get("/:id/audit", rbacMiddleware("users:read"), async (req: AuthRequest, res) => {
    try {
  ...
  router.post("/:id/activate", rbacMiddleware("users:update"), async (req: AuthRequest, res) => {
    try {
  ...
  router.get("/:id", rbacMiddleware("users:read"), async (req: AuthRequest, res) => {
    try {
  ...
  router.patch("/:id", rbacMiddleware("users:update"), async (req: AuthRequest, res) => {

...
import {
  ...
  CreateContractorIncidentSchema,
  UpdateContractorIncidentSchema,
} from "./contractors.types.js";

export function createContractorsController(service: ContractorsService) {
  return {
    ...
    async create(req: AuthRequest, res: Response) {
      const data = req.body as z.infer<typeof CreateContractorSchema>;
    ...
    async update(req: AuthRequest, res: Response) {
      ...
      await writeAuditLog({
        ...
        changes: diffRecord(before as unknown as Record<string, unknown>, contractor as unknown as Record<string, unknown>),
        actor: req.user,
        request: req,
      });
      res.json({ data: contractor });
    ...
    async delete(req: AuthRequest, res: Response) {
      ...
      if (!deleted) throw new NotFoundError("Contractor");
      await writeAuditLog({
    ...
    async recordIncident(req: AuthRequest, res: Response) {
      const data = req.body as z.infer<typeof CreateContractorIncidentSchema>;
    ...
    async updateIncident(req: AuthRequest, res: Response) {
      ...
      if (!before) throw new NotFoundError("Contractor incident");
    ...
    async deleteIncident(req: AuthRequest, res: Response) {
      ...
      if (!deleted) throw new NotFoundError("Contractor incident");
      await writeAuditLog({

...
import {
  ...
  UpdatePermitInputSchema,
  AdvancePermitStatusSchema,
} from "./permits.types.js";

export function createPermitsController(service: PermitsService) {
  return {
    ...
    async create(req: AuthRequest, res: Response) {
      const data = req.body as z.infer<typeof CreatePermitInputSchema>;
    ...
    async update(req: AuthRequest, res: Response) {
      ...
      if (!before) throw new NotFoundError("Permit");
      const permit = await service.updatePermit(
    ...
    async advanceStatus(req: AuthRequest, res: Response) {
      ...
      if (!updated) throw new NotFoundError("Permit");
...
export function createPermitsRouter() {
  ...
  router.post(
    "/",
    rbacMiddleware("permits:create"),
    validate(CreatePermitInputSchema),
    controller.create,
  );
  router.patch(
    "/:id",
  ...
  router.post(
    "/:id/advance",
    rbacMiddleware("permits:approve"),

...
export function hasPermission(
  ...
  return (
    ...
    permissions.includes(requiredPermission as Permission)
  );
}

export function recordAuthFailure(req: AuthRequest, permission: string, statusCode: number) {
...
export function rbacMiddleware(requiredPermission: Permission | string) {
...
export const ROUTE_PERMISSION_MATRIX: Record<string, Permission> = {
